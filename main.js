...
Vue.component('content', {
    ...
    partials: {
        home: 'Hey there! I am currently a junior studying <b>Electrical Engineering &amp; Computer Science</b> at the <b>University of California, Berkeley</b>. I will start my summer internship at <a href="http://www.pinterest.com/" class="text-link">Pinterest</a> in the Summer of 2015 doing web development. I&lsquo;m originally from New Mexico and I worked at the <a href="http://www.lanl.gov" class="text-link" target="_blank">Los Alamos National Laboratory</a> doing research during the Summer of 2013 and worked at <a href="http://www.eventable.com" class="text-link" target="_blank">Eventable</a> doing frontend developement during the Summer of 2014. I am passionate about web development and I am an officer at <a href="http://hackersatberkeley.com" class="text-link" target="_blank">Hackers@Berkeley</a> in order to contribute to the growing hacking culture at UC Berkeley. I am a big fan of the Insanity fitness program. I play the cello and piano, as well as tennis and ping-pong.',
